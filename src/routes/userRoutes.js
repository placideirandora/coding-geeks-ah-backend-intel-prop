...
usersRouter.put('/:username/block', [verifyToken, checkAdmin, permission.updateUser, checkPermissions], UserAuth.blockerUser);
usersRouter.put('/:username/unblock', [verifyToken, checkAdmin, permission.updateUser, checkPermissions], UserAuth.unblockerUser);
